 ...
 */
$config['db_host'] = getenv_docker('CSCART_DB_HOST', 'localhost');
$config['db_user'] = getenv_docker('CSCART_DB_USER','root');
$config['db_password'] = getenv_docker('CSCART_DB_PASSWORD','');
